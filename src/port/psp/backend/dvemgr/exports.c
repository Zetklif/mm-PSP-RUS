...
extern int pspDveMgrSetEdramSize;
static const unsigned int __pspDveManager_exports[6] __attribute__((section(".rodata.sceResident"))) = {
    0x2ACFCB6D,
    0xF9C86C73,
    0xC8CCE483,
    (unsigned int) &pspDveMgrCheckVideoOut,
    (unsigned int) &pspDveMgrSetVideoOut,
    (unsigned int) &pspDveMgrSetEdramSize,
};

extern int pspDveMgrCheckVideoOut;
extern int pspDveMgrSetVideoOut;
extern int pspDveMgrSetEdramSize;
static const unsigned int __pspDveManager_driver_exports[6] __attribute__((section(".rodata.sceResident"))) = {
    0x2ACFCB6D,
    0xF9C86C73,
    0xC8CCE483,
    (unsigned int) &pspDveMgrCheckVideoOut,
...
const struct _PspLibraryEntry __library_exports[3] __attribute__((section(".lib.ent"), used)) = {
    ...
    { "pspDveManager", 0x0000, 0x4001, 4, 0, 3, (unsigned int *) &__pspDveManager_exports },
    { "pspDveManager_driver", 0x0000, 0x0001, 4, 0, 3, (unsigned int *) &__pspDveManager_driver_exports },
};
